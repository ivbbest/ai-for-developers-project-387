...
- [ ] Коммит + пуш каркаса контекста в `main` — пользователь. Исключение из
      git-workflow (прямой пуш без ветки/PR), осознанное: каркас — не код,
      ревьюить нечего; прецедента на шаги 1–6 не создаёт
- [ ] После коммита каркаса: обновить ожидаемый статус в V1
      ...
      каркаса — после коммита разойдётся с фактом)
...
## Шаг 1 — Перенос кода + план развития — ветка `feat/migrate-app`
