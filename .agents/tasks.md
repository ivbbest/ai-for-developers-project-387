...
все слиты; три ревью-документа перенесены в `docs/archive/` (PR архивации).
...
- [x] #33 мерж + фиксация решений В1–В3: слит `5f7cbc8`; В1 — курс закрыт
      ...
      за владельцем)
- [ ] Пользователь: лимит расходов в кабинете провайдера (вторая половина P.3);
      если лимитов не предусмотрено — записать «страховка = фильтр круга
      вызывающих» и закрыть P.3 по факту. Удалить слитые remote-ветки-призраки
      `chore/migrate-app`, `docs/scaffold-closure` (удаление remote — только
      владелец)
...
**Инвентарь:** PR #1–#36 закрыты/слиты; открытый — только PR архивации ревью-
документов; issues: #6/#10 closed, #12 open (критерии есть, работа не начата),
