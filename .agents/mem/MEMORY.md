...
- 2026-09-04 | project | **Состояние: перенесён только каркас курса** (README-шаблон, hexlet-check.yml, input/). Код приложения из предшественника **не перенесён** — это шаг 1; заодно нужен план развития (≥1 фича, ≥1 баг в виде пользовательской жалобы) | tasks.md шаг 1
