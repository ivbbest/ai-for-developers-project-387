...
Статус: вариант A (Render) — выбранный путь для этого репозитория, деплой настраивается (URL фиксируется здесь и в README после публикации); вариант B (VPS) — запасной путь
